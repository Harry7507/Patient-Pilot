...
class IntakeSession(Base):
    ...
    socrates: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True, default=dict)
    associated_symptoms: Mapped[Optional[List[str]]] = mapped_column(JSONB, nullable=True, default=list)
    chronic_conditions: Mapped[Optional[List[str]]] = mapped_column(JSONB, nullable=True, default=list)
    is_ayush_active: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ayush_assessment: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True, default=dict)
